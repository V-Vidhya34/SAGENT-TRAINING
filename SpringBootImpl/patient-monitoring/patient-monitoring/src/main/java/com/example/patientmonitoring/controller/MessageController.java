...
public class MessageController {
    ...
    public List<Message> getByPatient(@PathVariable int patientId) {
        return messageService.getByPatient(patientId);
    }

    @GetMapping("/doctor/{doctorId}")
    public List<Message> getByDoctor(@PathVariable int doctorId) {
        return messageService.getByDoctor(doctorId);
    }
}